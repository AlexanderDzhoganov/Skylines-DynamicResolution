    ...
    public class DummyHook : MonoBehaviour
    {
        ...
        public void OnRenderImage(RenderTexture src, RenderTexture dst)
        {
            ...
            if (factor != 1.0f)
            {
                ...
                downsampleShader.SetVector("_ResampleOffset", new Vector4(rt.texelSize.x, 0.0f, 0.0f, 0.0f));
                Graphics.Blit(rt, rt2, shader);

                downsampleShader.SetVector("_ResampleOffset", new Vector4(0.0f, rt.texelSize.y, 0.0f, 0.0f));
                Graphics.Blit(rt2, dst, shader);
            }
            else
            {
